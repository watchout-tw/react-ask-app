  ...
  _render (props, state) {
    ...
    <div className="wrapper">
            ...
            <div className="index_subsection">
                ...
                <p>「市長給問嗎！最後一役」，邀請你把所有還來不及說出口的疑問和質疑一次提出，馮光遠、連勝文、柯文哲三位市長候選人將分別於直播節目中回答！</p>
            </div>
            <div className="index_subsection">
                <div className="index_title">活動說明</div>
                <p>即日起～各候選人直播節目前一天晚上 23:59 為止，於網站上提問、連署，候選人將依連署票數高低回答市民提問。</p>
                <p>提問日期：
                    <ul>
                    <li>馮光遠：即日起～ 11/17 23:59</li>
                    <li>連勝文：即日起～ 11/20 23:59</li>
                    <li>柯文哲：即日起～ （時間未定）</li>
                    </ul>
                </p>
                <p>直播日期：
